...
#data imports
import asset_paths
from bol_fake_data import archived_taahod
...
class ArchivedTaahod(ctk.CTkFrame):
    ...
    def __init__(self, parent, back_to_taahod):
        ...
        for i, item in enumerate(archived_taahod):
        ...
        ck.make_label(main_box, 150, 50, colors.white, colors.white, colors.black, "آرشیو تعهدنامه ها", 0, 
        ...
        ck.make_button(main_box, "بازگشت", 150, 50, (None, 22, "bold"), 20,
                       ...
                       back_to_taahod, 0.075, 0.94, "center")
