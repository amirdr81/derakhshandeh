...
#data imports
import asset_paths
from bol_fake_data import archived_workcart
...
class ArchivedWorkcart(ctk.CTkFrame):
    ...
    def __init__(self, parent, back_to_workcart):
        ...
        for i, item in enumerate(archived_workcart):
        ...
        ck.make_label(main_box, 150, 50, colors.white, colors.white, colors.black, "آرشیو کارت های تردد", 0, 
        ...
        ck.make_button(main_box, "بازگشت", 150, 50, (None, 22, "bold"), 20,
                       ...
                       back_to_workcart, 0.075, 0.94, "center")
