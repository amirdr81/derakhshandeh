...
#data imports
import asset_paths
from bol_fake_data import archived_car_licence
...
class ArchivedLicence(ctk.CTkFrame):  
    def reveiw_licence(self):
        selected_data = archived_car_licence[int(self.tree.item(self.tree.selection()[0], 'values')[0]) - 1]
    ...
    def __init__(self, parent, back_to_licence):
        super().__init__(parent)
        
        self.back_to_licence = back_to_licence
        ...
        ck.make_button(main_box, "چاپ گواهینامه‌ها", 150, 45, (None, 22, "bold"), 20, 
                       colors.white, colors.white, colors.dark_green_5, colors.green_3,
                       lambda: cc.print_group(archived_car_licence), 0.98, 0.23, "ne")
        ...
        for i, item in enumerate(archived_car_licence):
            self.add_row((
                cc.eng_to_persian_date(str(i + 1)),
                cc.eng_to_persian_date(item["licence_id"]),
                cc.eng_to_persian_date(item["car_id"]))
            )
        ...
        #اجزای صفحه
        ck.make_label(main_box, 150, 50, colors.white, colors.white, colors.black, "آرشیو گواهینامه‌ها", 0, 
                      None, (None, 45, "bold"), 0.5, 0.1, "center")
        
        ck.make_button(main_box, "بازگشت", 150, 50, (None, 22, "bold"), 20,
                       colors.white, colors.white, colors.dark_green_5, colors.green_3,
                       back_to_licence, 0.075, 0.94, "center")
